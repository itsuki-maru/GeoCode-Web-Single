...
![01_geocode-web-single.png](https://geocode-web-single.pages.dev/01_geocode-web-single.png)
...
![09_geocode-web-single.gif](https://geocode-web-single.pages.dev/09_geocode-web-single.gif)
...
<img src="https://geocode-web-single.pages.dev/03_geocode-web.png" width="300px">
...
通常の変更確認用 workflow として `.github/workflows/ci.yml` を用意している。PR と `main` / `master` への push で以下を実行する。

- `cargo fmt --check`
- `cargo test`
- 3 系統フロントエンドの `npm run type-check`
