...
const mapEditorProfile = Object.freeze({
  bindPolylineHoverHighlight: true,
  isShapeVisibleForMeasurement: (layer) =>
    isShapeVisibleForExternalFilter(layer),
  shouldSuppressShapeLabelClick: () => isShapeLabelClickSuppressed(),
});
...
const SHAPE_VERTEX_ADD_TOLERANCE_PX = 14;
const SHAPE_VERTEX_MIN_DISTANCE_PX = 10;
